package com.ngi.jatenginyourhand.ar.rotation;
...
import com.ngi.jatenginyourhand.ar.model.PlacesModel;
import com.ngi.jatenginyourhand.contextmenu.ContextMenuDialogFragment;
import com.ngi.jatenginyourhand.contextmenu.MenuObject;
import com.ngi.jatenginyourhand.contextmenu.MenuParams;
import com.ngi.jatenginyourhand.contextmenu.interfaces.OnMenuItemClickListener;
import com.ngi.jatenginyourhand.description.DescriptionActivity;
...
public class ARActivity extends AppCompatActivity implements SensorEventListener, LocationListener, OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showDist = settings.getInt("DISTANCE_FILTER", 10); //10 default vaulenya
        ...
        txtFilterDist.setText("Radius " + Integer.toString(showDist) + " Km");
        ...
        seekFilter.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                txtFilterDist.setText("Radius " + Integer.toString(progress) + " Km");
                showDist = progress;
