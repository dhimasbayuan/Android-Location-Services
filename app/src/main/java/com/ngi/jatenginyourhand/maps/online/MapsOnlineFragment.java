package com.ngi.jatenginyourhand.maps.online;
...
import com.ngi.jatenginyourhand.maps.shared.ClusterMarkerLocation;
import com.ngi.jatenginyourhand.maps.shared.DataSearchAdapter;
        ...
        vFabDir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cek_status(getActivity())) {
                    ...
                    Toast.makeText(getActivity(), getString(R.string.internetnotconnect), Toast.LENGTH_LONG).show();
                }
            }
        });
        return rootView;
